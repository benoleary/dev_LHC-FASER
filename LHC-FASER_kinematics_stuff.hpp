...
namespace LHC_FASER
{
  ...
  // at primary_lepton_cut.
  class single_lepton_cut : public acceptanceCutSet
  {
   ...
   * acceptance.
   */
  class leptonAcceptanceCut : public readied_for_new_point,
  ...
  protected:
    ...
    colored_cascade const* const first_sQCD_cascade;
    colored_cascade const* const second_sQCD_cascade;
    leptonAcceptanceCut stored_acceptance;
    bool not_already_calculated;
  ...
  inline bool
  single_lepton_cut::isSameAcceptanceCutSet(
                              acceptanceCutSet const* const comparison_cuts )
  const
  {
  ...
  inline double
  leptonAcceptanceCut::getEffectiveSquarkMass()
  {
    // debugging:
    /**std::cout
    << std::endl
    << "debugging: leptonAcceptanceCut::getEffectiveSquarkMass() called.";
    std::cout << std::endl;**/
  ...
  inline double
  leptonAcceptanceCut::acceptanceAt( double const givenEnergy,
                                     double const givenCut )
  /* this checks to see if the acceptances need updating, then returns
   * calculateAcceptanceAt( givenEnergy,
   *                        givenCut ), which interpolates the values in
   ...
   */
  {
    ...
    /**std::cout
    << std::endl
    << "debugging: leptonAcceptanceCut::acceptanceAt( " << givenEnergy
    << ", " << givenCut << " ) called.";
    std::cout << std::endl;**/
